...
public class OldMacdonald {
	public static void main(String[] args) {
		...
		FarmAnimal[] farmAnimals = new FarmAnimal[] { new Cow(), 
		...
		System.out.println("My " + tractor.getName() + 
				" goes " + tractor.getSoundTwice());
		
		Scanner input = new Scanner(System.in);
		System.out.println("What type of crop do you wish you wish to buy");
