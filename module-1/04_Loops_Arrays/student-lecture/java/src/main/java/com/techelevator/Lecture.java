...
public class Lecture {
    ...
    */
    public int[] returnArray() { //return an array of integers
    ...
    */
    public int returnLastElement() {
        int[] portNumbers = { 80, 8080, 443 };
        return portNumbers[portNumbers.length-1]; //returns last number in array or portNumbers[2]
    }
    ...
    */
    public int returnLastElementOfParam(int[] passedInArray) {
        return passedInArray[passedInArray.length-1]; //bc no idea how many elements   
        }
