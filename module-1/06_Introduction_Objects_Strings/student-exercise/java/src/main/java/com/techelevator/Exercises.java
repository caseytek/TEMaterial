...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		String firstLetter = str.substring(stringLength-2, stringLength-1);
		String secondLetter = str.substring(stringLength-1);
		return firstLetter + secondLetter + firstLetter + secondLetter + firstLetter + secondLetter;
	}
	...
	public String firstHalf(String str) {
		...
		String firstHalf = str.substring(0, halfOfString);
		return firstHalf;
	}
	...
	public String withoutEnd(String str) {
		String withoutEnds = str.substring(1, str.length()-1);
		return withoutEnds;
	}
	...
	public String left2(String str) {
		...
		String withoutFirstTwoChars = str.substring(2);
		return withoutFirstTwoChars + firstTwoChars;
	}
	...
	public String right2(String str) {
		...
		String withoutLastTwoChars = str.substring(0, str.length()-2);
		return lastTwoChars + withoutLastTwoChars;
	}
	...
	public String withoutEnd2(String str) {
		...
		String withoutEnds2 = str.substring(1, str.length()-1);
		result = withoutEnds2;
	} return result;
	}
	...
	public String middleTwo(String str) {
		String theFirstHalf = str.substring(0, str.length()/2);
		String theSecondHalf = str.substring(str.length()/2);
		String firstLetter = theFirstHalf.substring(theFirstHalf.length()-1);
		String secondLetter = theSecondHalf.substring(0,1);
	...
	public boolean endsLy(String str) {
		...
		if (str.length() < 2) {
			...
			if (str.equals(lyCheck)) {
				result = true;
			} 		
		} 
		else if (str.substring(str.length()-2).equals(lyCheck)) {
			result = true;
		}
		return result;
	}
	...
	public String twoChar(String str, int index) {
		String result = "";
		if (index < 0 || index > str.length()-2 || str.length() == 2) {
	...
	public String altPairs(String str) {
		String answer = "";
		for (int i = 0; i < str.length(); i += 4) { // so it can start at next position for adding to answer
			answer += str.charAt(i);
			if(i+1 < str.length()) {
