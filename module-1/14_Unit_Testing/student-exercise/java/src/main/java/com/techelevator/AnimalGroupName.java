...
public class AnimalGroupName {
    ...
    /*
     * Given the name of an animal, return the name of 
     * a group of that animal
     * (e.g. "Elephant" -> "Herd", "Rhino" - "Crash").
     *
     * The animal name should be case insensitive so 
     * "elephant", "Elephant", and
     * "ELEPHANT" should all return "herd".
     *
     * If the name of the animal is not found, null,
     *  or empty, return "unknown".
     *
     * Rhino -> Crash
     * Giraffe -> Tower
     * Elephant -> Herd
    ...
    public String getHerd(String animalName) {
        ...
        if (animalName != null && animals.containsKey
